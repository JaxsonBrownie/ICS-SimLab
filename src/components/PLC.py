...
# PURPOSE:  Defines an asynchronous function to be used to start a modbus tcp server
...
# PURPOSE:  Starts asynchronous function to use for modbus rtu server
...
def main():
    ...
    asyncio.run(start_servers(configs, context))
